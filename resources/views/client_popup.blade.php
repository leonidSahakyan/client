        ...
        <div class="row">
            <div class="{{ $client && $client->custom_fee == 1 ? 'col-4' : 'col-6' }} popup-main">
                ...
                <div id="lender_container" style="display:{{ ($client && $client->type === 1)?'block':'none'  }}">
                    ...
                    <div id="lender_container_new" class="main-form-content">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="lender_name" type="text" id="example-lender-name-input"
                                   placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="example-lender-email-input" class="col-form-label">Email</label>
                            <input class="form-control" type="email" name="lender_email" id="example-lender-email-input"
                ...
                <div id="lawyer_container" style="display:{{ ($client && $client->type === 2)?'block':'none'  }}">
                    ...
                    <div id="lawyer_container_new" class="main-form-content">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="lawyer_name" type="text" id="example-lawyer-name-input"
                                   placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="example-lawyer-email-input" class="col-form-label">Email</label>
                            <input class="form-control" type="email" name="lawyer_email" id="example-lawyer-email-input"
                                   placeholder="name@example.com">
                        </div>
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="custom-select form-control">
                        ...
                        <option {{ $client && $client->status == 2 ? 'selected="selected"' : "" }} value="2">Completed
                        </option>
                        <option {{ $client && $client->status == 3 ? 'selected="selected"' : "" }} value="3">Cancelled
                        </option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="repaymentType" class="form-control">
                        ...
                        <option value="2">elastic repayments</option>
                    </select>
                </div>
                <div class="form-group">
                    <button type="button" class="btn btn-primary" onclick="openCalculatorModal()">
                        Calculate
                    </button>
                </div>
            ...
            <div class="{{ $client && $client->custom_fee == 1 ? 'col-4' : 'col-6' }} popup-main">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="email" name="email" value="{{ $client ? $client->email : "" }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="address" value="{{ $client ? $client->address : "" }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="closing_date" value="{{ $client ? $client->closing_date : "" }}"

...
<div class="modal-body">
    <form class="save-client" action="JavaScript:void(0);">
        ...
        <div class="s-sw-title custom-fee-swicher">
            <h5>Custom fee</h5>
            <div class="s-swtich">
                <input type="checkbox" name="custom_fee_switcher" {{ $client && $client->custom_fee == 1 ? 'checked="checked"' : "" }} id="custom_fee_switcher">
            ...
            <div class="{{ $client && $client->custom_fee == 1 ? 'col-4' : 'col-6' }} popup-main">
                <div class="form-group">
                    ...
                    <select name="type" class="custom-select form-control" id="select-type">
                        ...
                        <option {{ $client && $client->type == 1 ? 'selected="selected"' : "" }} value="1">Lender</option>
                ...
                <div id="lender_container" style="display:{{ ($client && $client->type === 1)?'block':'none'  }}">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" name="lender_id" id="select-lender">
                            ...
                            <option {{ $client && $client->lender_id == $agent->id ? 'selected="selected"' : "" }} value="{{$agent->id}}">{{$agent->name}} ({{$agent->phone}})</option>
                            @endforeach
                        </select>
                    </div>
                    <div id="lender_container_new" class="main-form-content">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="lender_email" id="example-lender-email-input" placeholder="name@example.com">
                        </div>
                        <div class="form-group">
                            <label for="example-lender-tel-input" class="col-form-label">Phone</label>
                            <input class="form-control" type="tel" name="lender_phone" id="example-lender-tel-input" placeholder="123-456-789">
                        </div>
                    </div>
                </div>
                <div id="lawyer_container" style="display:{{ ($client && $client->type === 2)?'block':'none'  }}">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" name="lawyer_id" id="select-lawyer">
                            ...
                            <option {{ $client && $client->lawyer_id == $agent->id ? 'selected="selected"' : "" }} value="{{$agent->id}}">{{$agent->name}} ({{$agent->phone}})</option>
                            @endforeach
                        </select>
                    </div>
                    <div id="lawyer_container_new" class="main-form-content">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="lawyer_email" id="example-lawyer-email-input" placeholder="name@example.com">
                        </div>
                        <div class="form-group">
                            <label for="example-lawyer-tel-input" class="col-form-label">Phone</label>
                            <input class="form-control" type="tel" name="lawyer_phone" id="example-lawyer-tel-input" placeholder="123-456-789">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <select name="status" class="custom-select form-control">
                        ...
                        <option {{ ($client && $client->status == 1) || (!$client)  ? 'selected="selected"' : "" }} value="1">Active</option>
                        <option {{ $client && $client->status == 2 ? 'selected="selected"' : "" }} value="2">Completed</option>
                        <option {{ $client && $client->status == 3 ? 'selected="selected"' : "" }} value="3">Cancelled</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="name" value="{{ $client ? $client->name : "" }}" type="text" id="example-name-input" placeholder="Name">
                </div>
                <div class="form-group">
                    <label for="example-email-input" class="col-form-label">Email</label>
                    <input class="form-control" type="email" name="email" value="{{ $client ? $client->email : "" }}" id="example-email-input" placeholder="name@example.com">
                </div>
            </div>
            <div class="{{ $client && $client->custom_fee == 1 ? 'col-4' : 'col-6' }} popup-main">
                <div class="form-group">
                    <label for="example-tel-input" class="col-form-label">Phone</label>
                    <input class="form-control" name="phone" value="{{ $client ? $client->phone : "" }}" type="tel" id="example-tel-input" placeholder="123-456-789">
                </div>
                <div class="form-group">
                    <label for="example-address-input" class="col-form-label">Address</label>
                    <input class="form-control" type="text" name="address" value="{{ $client ? $client->address : "" }}" id="example-address-input" placeholder="Address">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select form-control" name="agent_id" id="select-agent">
                        ...
                        @foreach ($agents as $agent)
                            ...
                            <option {{ $client && $client->agent_id == $agent->id ? 'selected="selected"' : "" }} value="{{$agent->id}}">{{$agent->name}} ({{$agent->phone}})</option>
                        @endforeach
                    </select>
                </div>
                <div id="agent_container" class="main-form-content">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" name="agent_email" id="example-agent-email-input" placeholder="name@example.com">
                    </div>
                    <div class="form-group">
                        <label for="example-agent-tel-input" class="col-form-label">Phone</label>
                        <input class="form-control" type="tel" name="agent_phone" id="example-agent-tel-input" placeholder="123-456-789">
                    </div>
                </div>
            </div>
...
<div class="modal-footer">
    ...
    <button type="button" id='saveClientBtn' onclick="saveClient();" class="btn btn-success">{{ $client ? "Save" : "Add" }}</button>
</div>
